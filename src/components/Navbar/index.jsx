...
const Navbar = ({ dark, clickToggle }) => {
  ...
  return (
    <div className="container-md py-[30px] h-[70px] md:h-[100px] flex items-center justify-between w-full bg-white dark:bg-[#121212] sticky top-0 z-[1]">
      ...
      <div className="items-center gap-[30px] justify-between hidden lg:flex">
        <ul className="flex items-center gap-[20px] text-[14px] font-bold text-[#282828] dark:text-white">
          <NavLink
            to="/"
        ...
        <ul className=" flex flex-row gap-[20px]">
          <li>
            ...
            >
              <path
                className="dark:fill-[#fff] fill-[#282828]"
        ...
        <div>
          ...
          <label
            htmlFor="checkbox"
            className="checkbox-label bg-[#111] dark:bg-white"
          >
            <svg
            ...
            <span className="ball bg-white dark:bg-[#111]"></span>
          </label>
        </div>
      </div>

      <svg
        className="w-[20px] lg:hidden fill-black dark:fill-white"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 448 512"
        onClick={() => {
          setShowNav(true);
      ...
      <div
        className={`lg:hidden transition-3s fixed top-0 z-[100] left-[-100%] w-full h-full bg-white dark:bg-[#121212] ${
          showNav ? "!left-0" : ""
        }`}
      >
        ...
        <ul className="flex flex-col p-[20px] gap-[20px] text-[14px] font-bold text-[#282828] dark:text-white">
          <NavLink
            to="/"
            className={({ isActive, isPending }) =>
              isPending ? "pending" : isActive ? "linear-text" : ""
